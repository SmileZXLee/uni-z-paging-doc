...
⑥上方 ②、③、④、⑤的问题可通过使用`兼容模式`解决，在微信小程序中推荐使用兼容模式的写法！
:::
...
| use-compatibility-mode <Badge text="2.4.0"/> | 在使用虚拟列表时，是否使用兼容模式，兼容模式写法较繁琐，但可提供良好的兼容性。在微信小程序中，推荐使用兼容模式。具体写法请参照demo中的`virtual-list-compatibility-demo` | Boolean        | false  | true    |
